<div class="modal fade" id="showAdditionalTaskModal" aria-hidden="true" tabindex="-1" role="dialog" data-backdrop="false">
                                ...
                                <ul class="list-unstyled list-unstyled-border list-unstyled-noborder">
                                    <li class="media">
                                        <div class="media-body">
                                            ...
                                            <div class="media-title mb-1">Sending to
                                                {{ isset($receiver) ? $receiver : 'John Doe' }}</div>
